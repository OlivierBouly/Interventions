...
describe('Zones Validator', () => {
    ...
    it('une phrase avec 1 espace et 2 caracteres est invalide', () =>{
        let validator = ZonesValidator.plage(3);
    ...
    it('une phrase avec 2 espace et 1 caracteres est invalide', () =>{
        let validator = ZonesValidator.plage(3);
        let control = {value: "  x"};
        let result = validator(control as AbstractControl);
        expect(result['nbreCharsInsuffisants']).toBe(true);
    ...
    it('une phrase avec 3 espaces et 3 characteres est valide', () =>{
        let validator = ZonesValidator.plage(3);
    ...
    it('une phrase avec 5 espaces et 5 characteres et 5 espaces est valide', () =>{
        let validator = ZonesValidator.plage(3);
    ...
    it('une chaine nulle est invalide', () =>{
        let validator = ZonesValidator.plage(3);
